...
const navigationItems = [
    { icon: BookOpen, label: "Colleges", href: "/government/colleges" },
    { icon: LayoutDashboard, label: "Analysis", href: "/government/analysis" },
    { icon: Users, label: "Top Colleges", href: "/government/top-colleges" },
]
...
export function GovernmentSidebar() {
    ...
    return (
        <aside className="w-64 bg-white border-r border-gray-100 flex flex-col shrink-0 fixed h-full z-20">
            <div className="p-8">
                <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Mantrix Gov</h1>
            </div>
